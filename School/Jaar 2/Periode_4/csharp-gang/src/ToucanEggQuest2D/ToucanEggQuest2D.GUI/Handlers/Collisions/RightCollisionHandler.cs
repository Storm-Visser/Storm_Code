...
{
    public class RightCollisionHandler
    {
        private readonly PlayPage playPage;
        private readonly CollisionHandler collisionHandler;

        public RightCollisionHandler(PlayPage playPage, CollisionHandler collisionHandler)
        {
        ...
        private bool EnemyColliding()
        {
            ...
            {
                if (collisionHandler.Collision.CollidingFromRight(playPage.RenderHandler.ToucanUI.Source, o.Source))
                {
